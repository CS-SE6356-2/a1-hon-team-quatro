...
public class ClientController {
	...
	public ClientController() {
		...
		serverThread = new ServerThread(this, null);
		isServer = false;
...
class ServerThread extends Thread{
	...
	public ServerThread(ClientController game,CardGame cardGame) {
		this.game = game;
	...
	public void run() {
		...
		//If we are not in the game, then finish
		if(!game.gui.state.equals("game")) return;
		//Else then keep running
